...
//  //   console.log("View button clicked for completed lead ID:", id);
...
const CompletedLead = () => {
  ...
  // Handle view button click
  const handleViewClick = (leadData) => {
    setLead(leadData);
    setAdDescription(leadData.adDescription || "");
    setAdNote(leadData.adNote || "");
    setIsModalOpen(true);
  };
  ...
  return (
    <div className="w-screen overflow-scroll sm:container mx-auto p-6 bg-green-100 ">
      <h1 className="text-3xl font-bold text-green-700 text-center mb-8">
        Completed Leads
      </h1>
            ...
            {completedLeads.map((lead) => (
              <tr key={lead._id} className="hover:bg-gray-100">
                ...
                <td className="py-2 px-4 border-b flex">
                  <button
                    className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition duration-300"
                    onClick={() => handleViewClick(lead)} // Open modal with lead details
                  >
                    View
                  </button>
                  <button
          ...
          <div className="bg-white p-8 rounded-lg shadow-md w-3/4 md:w-1/2 relative">
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                ...
                {lead.adImageURL && (
                <img src={lead.adImageURL} alt="Advertisement" width={300} height={300} />
              )}
              {lead.adVideoURL && (
                <video src={lead.adVideoURL} controls width={300} height={300} />
              )}
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                <div>
