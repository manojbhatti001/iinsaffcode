...
//  //   console.log("View button clicked for cancelled lead ID:", id);
...
const CancelledLead = () => {
  ...
  return (
    <div className="w-screen overflow-scroll sm:container mx-auto p-6 bg-red-100">
      <h1 className="text-3xl font-bold text-red-700 text-center mb-8">
        Cancelled Leads
      </h1>
