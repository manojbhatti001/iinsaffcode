...
import drLawyer from "../../../assets/services/doctors.jpg";
  ...
  return (
    <div className="p-4">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800">Join Organization </h1>
      </div>
      ...
      <div className=" flex sm:flex flex-col lg:flex-col xl:flex-row xl:flex items-center justify-center gap-6">
        ...
        <div className="w-[60%] lg:w-[50%] flex justify-center">
          <img
            src={drLawyer} // Replace with your image URL
            alt="DrLawyer Service"
